...
async function main() {
  ...
  const journalModel = await client.journals.editor.modelInfo(JOURNAL_ID);
  ...
  await client.journals.editor.edit(JOURNAL_ID, [
  ...
  ], true); // sync_realtime_state defaults to true
